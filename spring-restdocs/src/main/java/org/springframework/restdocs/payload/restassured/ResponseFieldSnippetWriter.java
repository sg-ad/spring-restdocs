 ...
 * 
 */
public class ResponseFieldSnippetWriter extends FieldSnippetWriter {

	public ResponseFieldSnippetWriter(String outputDir, List<FieldDescriptor> descriptors) {
	...
	protected Reader getPayloadReader(HttpRequest request, HttpResponse response, HttpContext context) throws IOException {
		return new StringReader(EntityUtils.toString(response.getEntity()));
	}
}
