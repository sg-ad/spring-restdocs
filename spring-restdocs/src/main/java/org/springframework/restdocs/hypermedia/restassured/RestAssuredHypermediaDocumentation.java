 ...
 * 
 */
public abstract class RestAssuredHypermediaDocumentation {

	private RestAssuredHypermediaDocumentation() {
	 ...
	 * @see RestDocumentationResultHandler#withLinks(LinkExtractor, LinkDescriptor...)
	 */
	public static LinkSnippetWriter documentLinks(String outputDir, LinkExtractor linkExtractor, LinkDescriptor... descriptors) {
		return new LinkSnippetWriter(outputDir, linkExtractor, Arrays.asList(descriptors));
	}
}
